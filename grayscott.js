...
var DiffusionVis = {
  ...
  init: function(options) {
    ...
    mColors[0].value = new THREE.Vector4(s.color1[0]/255, s.color1[1]/255, s.color1[2]/255, s.color1[3]);
    mColors[1].value = new THREE.Vector4(s.color2[0]/255, s.color2[1]/255, s.color2[2]/255, s.color2[3]);
    mColors[2].value = new THREE.Vector4(s.color3[0]/255, s.color3[1]/255, s.color3[2]/255, s.color3[3]);
